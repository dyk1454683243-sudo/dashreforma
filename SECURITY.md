...
This repository is a front end. It renders data returned by a backend API and
never stores credentials. Reports about the API itself should go to the
operator of that backend.
